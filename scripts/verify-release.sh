...
grep -Fxq 'dev/eigenworks/item/EngineersHandbookItem.class' <<<"$archive_entries"
grep -Fxq 'assets/eigenworks/items/engineers_handbook.json' <<<"$archive_entries"
grep -Fxq 'data/eigenworks/recipe/engineers_handbook.json' <<<"$archive_entries"
