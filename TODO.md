...
- [x] Maintenance 0.2.1: generate, package, document, and validate an optional resource pack covering all 19 custom blocks/tools.
- [x] Usability 0.2.2: add in-game quick start, context help for every device, hover controls, onboarding hint, recipe, and GameTest coverage.
